    ...
    const products = rows
      .map((row) => {
        ...
        return {
          ...
          promotionType: promo?.promotion_type === 'ONE_PLUS_ONE' ? '1+1' : promo?.promotion_type === 'TWO_PLUS_ONE' ? '2+1' : 'none',
          purchaseQuantity: promo?.promotion_type === 'TWO_PLUS_ONE' ? 2 : 1,
          rewardQuantity: promo?.promotion_type === 'ONE_PLUS_ONE' ? 2 : promo?.promotion_type === 'TWO_PLUS_ONE' ? 3 : 1,
